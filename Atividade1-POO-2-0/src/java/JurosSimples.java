...
public class JurosSimples extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body  background=\'https://viverdeblog.com/wp-content/uploads/2016/12/como-ganhar-dinheiro-com-blog-003.jpg' bgproperties=\"fixed\"><center>");
             out.println("<hr align='center' width='60%' size='80' color=blue>");
            out.println("<br>");
            out.println("<div><form> <h1>calculo de Juros Simples</h1> <br>");
            out.println(" -valor inicial: <input type='text' name='v_i'>");
            out.println(" -meses: <input type='text' name='meses'> ");
            out.println(" -percentual:<input type='text' name='i'><br> <br>");
            out.println("<input type='submit' name='Calcular'> <br><br><br>");
            out.print("</form></div>");
            ...
            js =(vi* I * ms);
            double mont= (vi + js);
            out.println("O montante é de: "+mont+" E valor do juros:"+js+"<br>");
